...
public class webPromotionSuite1 {
	...
	public void setUp() throws Exception {
		...
		itr = promotionController.getWebSpecialSpanPromotions();
	}
	...
	public void test1() {
		...
		promotionController.updateWebSpecialSpanPromotion(vo);
		
		Iterator<SpecialSpanPromotionVO> itr2 =  promotionController.getWebSpecialSpanPromotions();
		vo = itr2.next();
	...
	public void test2(){
		...
		promotionController.addWebSpecialSpanPromotion(vo);
	...
	public void test3(){
		assertEquals(ResultMessage.SUCCESS,promotionController.deleteWebSpecialSpanPromotion("国庆节"));
	}
