...
-- ----------------------------
BEGIN;
INSERT INTO `credit` VALUES ('1234567990', '2016-02-03 03:23:00', '182720160202', '1000', '1235', '未执行->已执行'), ('1234567990', '2016-03-02 05:31:00', '950820160301', '1235', '1931', '未执行->已执行'), ('1234567990', '2016-07-16 06:00:00', '796020160711', '1931', '33', '未执行->异常'), ('1234567990', '2016-07-16 10:21:00', '796020160711', '33', '3862', '异常->已执行'), ('1234567990', '2016-11-11 06:00:00', '781720161107', '3862', '2993', '未执行->异常'), ('1234567990', '2016-11-13 15:56:44', '781720161107', '2993', '3862', '异常->已撤销');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `hotelworker` VALUES ('98765441', '¤bcdefg', '南京英尊假日酒店'), ('98765442', '¤bcdefg', '南京天丰大酒店'), ('98765443', '¤bcdefg', '南京金陵饭店'), ('98765444', '¤bcdefg', '桔子水晶酒店（南京新街口店）'), ('98765445', '¤bcdefg', '汉庭酒店（南京夫子庙）'), ('98765446', '¤bcdefg', 'ZMAX潮漫酒店（南京夫子庙店）'), ('98765447', '¤bcdefg', '南京汤山御庭精品酒店');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order` VALUES ('182720160202', '1234567900', '98765441', '南京英尊假日酒店', '仙林大道168号', '235', '2016-02-03 06:00:00', '2016-02-04 04:00:00', '已执行', 'false', '几俻枡', 'bfcafbfdbba', '235', '2016-02-02 10:20:00', '2016-02-03 03:23:00', '2016-02-04 02:58:00', '单人间', '1', '301', '2', '无', '', '-1'), ('781720161107', '1234567900', '98765443', '南京金陵饭店', '汉中路2号', '869', '2016-11-11 06:00:00', '2016-11-12 04:00:00', '已撤销', 'false', '几俻枡', 'bfcafbfdbba', '869', '2016-11-06 18:56:00', null, null, '双人间', '1', '', '2', '无', '', '-1'), ('796020160711', '1234567900', '98765443', '南京金陵饭店', '汉中路2号', '1898', '2016-07-16 06:00:00', '2016-07-18 04:00:00', '已执行', 'true', '几俻枡', 'bfcafbfdbba', '1898', '2016-07-11 13:16:00', '2016-07-16 10:21:00', '2016-07-18 03:47:00', '双人间', '1', '5312', '2', '无', '地理位置特别好，交通、购物、吃饭、去景点都特别方便', '4.5'), ('801920161209', '1234567900', '98765446', 'ZMAX潮漫酒店（南京夫子庙店）', '夫子庙贡院街188号', '375', '2017-01-01 06:00:00', '2017-01-02 04:00:00', '未执行', 'false', '几俻枡', 'bfcafbfdbba', '375', '2016-12-09 12:06:00', null, null, '双人间', '1', '6407', '2', '无', '', '-1'), ('950820160301', '1234567900', '98765442', '南京天丰大酒店', '洪武路26号', '696', '2016-03-02 06:00:00', '2016-03-04 04:00:00', '已执行', 'true', '几俻枡', 'bfcafbfdbba', '696', '2016-03-01 14:20:00', '2016-03-02 05:31:00', '2016-03-04 00:58:00', '双人间', '1', '301', '2', '无', '环境很不错', '4.5');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `roominfo` VALUES ('98765441', '单人间', '20', '20', '235'), ('98765441', '双人间', '15', '15', '262'), ('98765442', '单人间', '25', '25', '358'), ('98765442', '双人间', '18', '18', '348'), ('98765442', '三人间', '8', '8', '328'), ('98765442', '商务套房', '12', '12', '228'), ('98765442', '总统套房', '4', '4', '560'), ('98765443', '单人间', '32', '32', '869'), ('98765443', '双人间', '45', '45', '949'), ('98765443', '商务套房', '16', '16', '1489'), ('98765443', '总统套房', '8', '8', '2389'), ('98765444', '单人间', '40', '40', '559'), ('98765444', '双人间', '35', '35', '509'), ('98765444', '商务套房', '28', '28', '619'), ('98765444', '总统套房', '12', '12', '669'), ('98765445', '单人间', '68', '68', '265'), ('98765445', '双人间', '58', '58', '360'), ('98765445', '三人间', '25', '25', '389'), ('98765446', '单人间', '45', '45', '375'), ('98765446', '双人间', '49', '49', '420'), ('98765446', '商务套房', '30', '30', '443'), ('98765447', '单人间', '30', '30', '858'), ('98765447', '双人间', '30', '30', '868'), ('98765447', '三人间', '25', '25', '1878'), ('98765447', '商务套房', '18', '18', '2580'), ('98765447', '总统套房', '9', '9', '4580');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `specialspanpromotion` VALUES ('98765441', '清明节', '0.75', '2016-04-03', '2016-04-05'), ('98765441', '双十一', '0.66', '2016-11-09', '2016-11-12'), ('98765442', '春节', '0.88', '2017-01-21', '2017-02-11'), ('99999999', '双十一', '0.5', '2016-11-11', '2016-11-11'), ('99999999', '春节', '0.75', '0001-01-01', '0001-01-01');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `webmarketer` VALUES ('100001', '¢¨£¥ª¦ ¡bcdefg'), ('100002', '¢¨£¥ª¦ ¡bcdefg'), ('100003', '¢¨£¥ª¦ ¡bcdefg'), ('100004', '¢¨£¥ª¦ ¡bcdefg'), ('100005', '¢¨£¥ª¦ ¡bcdefg');
COMMIT;
